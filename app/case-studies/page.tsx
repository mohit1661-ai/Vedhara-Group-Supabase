...
export const metadata: Metadata = { title:"Real Estate Case Studies | Delhi NCR", description:"Real estate case studies across Delhi NCR, Faridabad & Chandigarh: NRI purchase, portfolio restructuring, lease negotiation and first-time buying.", alternates:{ canonical:"https://www.vedharagroup.com/case-studies" } };
...
export default function CaseStudiesPage() {
  return (
    <>
      <VideoHeroSection poster="/videos/Case%20Studies%20Hero%20Video-poster.jpg" videoSrc="/videos/Case%20Studies%20Hero%20Video.mp4">
      ...
      <FAQSection
        faqs={[
          ...
          { q:"How does Vedhara's advisory differ from a typical broker?", a:"We are an independent advisory and brokerage firm. Our disclosed commission is never tied to pushing any developer's inventory, so every recommendation starts with your needs. The case studies above show the kind of measurable outcomes this independence produces, from price reductions to portfolio yield improvements." },
