...
const faqs = [
  ...
  { q:"Is the team available for weekend consultations?", a:"Yes. NRI clients and working professionals can schedule weekend and evening IST video consultations. Kusum Sharma's NRI desk operates dedicated Saturday and Sunday slots from 10 AM to 4 PM IST." },
  { q:"How large is the Vedhara Group team?", a:"Vedhara Group operates a lean, senior-led team model. Every client engagement is managed by a named senior advisor from day one, supported by dedicated research and documentation specialists." },
];
