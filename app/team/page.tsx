...
const faqs = [
  ...
  { q:"Does Vedhara Group charge buyers a fee?", a:"No. Our advisory services for buyers are entirely free. Our compensation comes from the developer side for verified transactions, which means your interests are not compromised by any fee obligation. This model allows us to offer unbiased advice without any cost to you as a buyer. For sellers and landlords, we operate on a transparent, pre-agreed fee structure." },
