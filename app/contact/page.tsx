...
const contactFaqs = [
  ...
  { q:"Which areas and services does Vedhara cover?", a:"We cover Delhi NCR, including Delhi, Gurugram, Noida, Greater Noida, Faridabad, Ghaziabad, and Sonipat, plus remote-first advisory for NRI clients worldwide. Services span buying, selling, renting, commercial, investment advisory, NRI services, property management, and luxury properties." },
