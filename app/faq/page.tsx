...
const faqGroups = [
  ...
  },
  {
    ...
    icon:"💼",
    faqs:[
      { q:"What is Vedhara's independent investment advisory approach?", a:"Vedhara's commission is never tied to pushing any developer's inventory. Every recommendation starts with the client's requirement, budget, and timeline, not our margin. We analyse micro-markets, infrastructure developments, rental demand, and price trends before shortlisting, and we will tell you when a property is not a good buy even if it means losing the engagement." },
...
export default function FAQPage() {
  return (
    <>
      ...
      <VideoHeroSection poster="/videos/FAQ%20Hub%20Hero%20Video-poster.jpg" videoSrc="/videos/FAQ%20Hub%20Hero%20Video.mp4">
