...
const values = [
  { icon:"⚖️", title:"Independence", desc:"No exclusive developer tie-ups. Every shortlist built around your requirements, not around which developer pays the highest commission." },
  { icon:"🔍", title:"Transparency", desc:"We publish our verification methodology, disclose our compensation model upfront, and document every step of the advisory process." },
  { icon:"🎯", title:"Dedication", desc:"One named advisor from day one. Not a rotating team, not a CRM ticket. Your advisor knows your requirements throughout the entire journey." },
  { icon:"📋", title:"Accountability", desc:"Every claim we make about a property is documented and verifiable. Our Verification Framework results are published on every listing page." },
];
            ...
            {values.map((v,i)=>(
              <ScrollReveal key={v.title} delay={i*80}>
                <div className="svc-card" style={{ background:"var(--cream)",borderRadius:0 }}>
                  <div className="svc-card-icon">{v.icon}</div>
