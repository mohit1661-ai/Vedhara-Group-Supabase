...
const cols = [
  ...
  { title:"Advisory",  links:[{l:"Investment Advisory",h:"/investment-advisory"},{l:"NRI Services",h:"/nri-services"},{l:"Property Management",h:"/property-management"},{l:"How We Charge",h:"/how-we-charge"},{l:"Verification Center",h:"/verification-center"},{l:"Free Calculators",h:"/calculators"}] },
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1.6fr 1fr 1fr 1fr 1fr",gap:40,paddingBottom:48,borderBottom:"1px solid rgba(255,255,255,0.06)" }} className="footer-grid">
          <div className="footer-brand">
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=Sushant+Lok+Phase+3+Gurugram" target="_blank" rel="noopener noreferrer" className="footer-link-item" style={{ display:"flex",alignItems:"center",gap:10 }}>
                ...
                Sushant Lok Phase 3, Gurugram, Haryana
              </a>
