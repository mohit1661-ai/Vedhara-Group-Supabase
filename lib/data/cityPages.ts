...
const gurugram: CityPageData = {
  ...
  listings: [
    ...
    { id:"gg-26", title:"3 Kay — Plotted Residence", location:"DLF Phase 1, Gurugram", price:"₹ 25 Cr", config:"Plot No. A2/6 · 490 sq.yds.", size:"490 sq.yds.", type:"Plotted", status:"Available for Sale", highlights:["DLF Phase 1","490 Sq.Yds. Plot","Prime Location","Ready to Build"], image:"/Images/Pushpanjali%20Farmhouse%20for%20sale.jpeg", alt:"3 Kay plotted residence on Plot A2/6, DLF Phase 1, Gurugram — 490 sq.yds. available for ₹25 Cr" },
