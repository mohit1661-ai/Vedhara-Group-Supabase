...
const L: SearchListing[] = [
  // ── NEW GURUGRAM HQ27 COMMERCIAL BUILDING (newest first) ──────
  { id:"ved-gbk2", title:"HQ27 Premium Commercial Building", location:"Near IFFCO Chowk & HUDA City Centre Metro, Gurugram", city:"gurugram", price:"₹ 2,250 Cr", value:225000, config:"Grade-A Commercial Building + Mall · 16 Floors + 3 Basements · 3 Acres · 280 Ft High · Office ~5 Lakh sq.ft. @ ₹160/sqft · Retail & F&B ~1 Lakh sq.ft. Pending Lease · Managed by Bharti · Near NH-48, Golf Course Road, IGI Airport", size:"~6 Lakh sq.ft. Leasable", type:"commercial", mode:"sell", category:"Commercial", image:"/Images/Premium%20Commercial%20Building%20Gurgaon.png", alt:"HQ27 premium Grade-A commercial building and mall near IFFCO Chowk, Gurugram: 6 lakh sq.ft. leasable on 3 acres with 11.5 Cr monthly rental income", link:"/gurugram", tag:"Available for Sale", keywords:kw("hq27 premium commercial building iffco chowk huda city centre metro gurugram gurgaon grade a commercial mall 16 floors 3 basements 3 acres 280 feet high 6 lakh sqft leasable office 5 lakh sqft retail fb 1 lakh sqft bharti managed rent 11.5 cr per month projected 150 cr annual income nh-48 golf course road igi airport 2250 cr for sale") },

  // ── NEW GURUGRAM RENTED BANK PROPERTY (newest first) ──────
  { id:"ved-gbk1", title:"Rented Bank Property, Sector 76", location:"Sector 76, DLF Phase 6, Gurugram", city:"gurugram", price:"₹ 2.22 Cr", value:222, config:"6 Ground-Floor Shops · 10-Yr Bank Lease · Rent ₹88/sqft · 3 Months Security Deposit", size:"2,520 sq.ft.", type:"commercial", mode:"sell", category:"Commercial", image:"/Images/Bank%20Property%20for%20sale%20in%20gurugram.png", alt:"Rented bank property for sale in Sector 76, DLF Phase 6, Gurugram: 2520 sq.ft. ground-floor shops with 10-year lease", link:"/gurugram", tag:"Rented – Available for Sale", keywords:kw("rented bank property sector 76 dlf phase 6 gurgaon gurugram ground floor shops 10 year lease fresh lease 88 per sqft 2520 sqft 6 shops 3 months security deposit 2.22 cr investment income commercial next to dlf privana near nh-8 spr upcoming metro proposed cyber city 2 1500 families premium residential") },

  // ── NEW GURUGRAM SECTOR 32 PRE-RENTED LISTING (newest first) ──────
  { id:"ved-g17", title:"Fully Furnished Pre-Rented Building", location:"Sector 32, Gurugram", city:"gurugram", price:"₹ 200 Cr Demand", value:20000, config:"4,000 sq.m. Plot · 1,25,000 sq.ft. Leased Area · B2 + 5 Floors · Single Tenant (Highly Reputed Company) · Newly & Fully Furnished · New Lease with 3-Year Lock-in · 15% Escalation Every 3 Years · Rent ₹1.17 Cr/month", size:"1,25,000 sq.ft. leased", type:"commercial", mode:"sell", category:"Commercial", image:"/Images/Fully%20Newly%20Furnished%20rented%20building%20in%20Sector%2032%20Gurgaon.webp", alt:"Fully furnished pre-rented commercial building with single reputed tenant in Sector 32, Gurugram", link:"/commercial", tag:"Available for Sale", keywords:kw("sector 32 gurgaon gurugram fully newly furnished running rented building pre-rented pre-leased single tenant big company highly reputed operator 4000 sqmt plot 125000 sqft leased area basement 2 plus 5 floors b2 5 1.17 cr per month rent 200 cr demand new lease 3 year lock-in 15 escalation every 3 years commercial investment property") },

  // ── NEW NEEMRANA INDUSTRIAL LISTING (newest first) ──────
  { id:"ved-nm1", title:"Pre-Leased Industrial Estate", location:"Ghiloth Industrial Area, Neemrana, Rajasthan", city:"neemrana", price:"₹ 250 Cr Demand", value:25000, config:"20-Acre Approved Industrial Plot · 6.5 Lakh sq.ft. Shed Area Across 3 Sheds · 1.10 Lakh sq.ft. RCC (Ground + 2 Floors) · Top MNC Electronics Manufacturing · Fresh 12-Year Lease with 3-Year Lock-in · Rent ₹1.60 Cr/month", size:"20 Acres · 6.5 Lakh sq.ft. Sheds · 1.10 Lakh sq.ft. RCC", type:"commercial", mode:"sell", category:"Industrial", image:"/Images/Neemrana%20Ghilot%20industrial%20area%20Image%20-%204.jpg", alt:"Pre-leased industrial estate with MNC electronics manufacturing tenant in Ghiloth Industrial Area, Neemrana", link:"/commercial", tag:"Available for Sale", keywords:kw("neemrana ghiloth ghilot industrial area rajasthan pre-leased industrial estate 20 acre approved industrial plot 6.5 lakh sqft shed area 3 sheds 1.10 lakh sqft rcc ground plus 2 floors mnc electronic components manufacturing fresh lease 1.60 cr per month rent 3 year lock-in 12 year lease 250 cr demand 225 cr net deal industrial property for sale") },
  ...
  { id:"ved-uv5", title:"Commercial Building, Udyog Vihar 5", location:"Udyog Vihar Phase 5, Gurugram", city:"gurugram", price:"₹ 40 Cr", value:4000, config:"40,000 sq.ft. Built-up", size:"1,000 sq. m.", type:"commercial", mode:"sell", category:"Commercial", image:"/Images/udyog-vihar-05.jpeg", alt:"Commercial building for sale in Udyog Vihar Phase 5, Gurugram", link:"/commercial", tag:"Available for Sale", keywords:kw("udyog vihar phase 5 gurugram gurgaon commercial building industrial for sale 40000 sqft built up") },
  { id:"ved-s16b", title:"MG Road Commercial Building", location:"Sector 16, Gurugram", city:"gurugram", price:"₹ 25 Cr", value:2500, config:"Commercial Building", size:"1,000 sq. m.", type:"commercial", mode:"sell", category:"Commercial", image:img(5859963), pos:"100%", alt:"Commercial building for sale in Sector 16 on MG Road, Gurugram", link:"/commercial", tag:"Available for Sale", keywords:kw("sector 16 gurugram gurgaon mg road sector 14 commercial building for sale") },
