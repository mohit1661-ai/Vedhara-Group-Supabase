...
const L: SearchListing[] = [
  ...
  { id:"ved-g17", title:"Fully Furnished Pre-Rented Building", location:"Sector 32, Gurugram", city:"gurugram", price:"₹ 200 Cr Demand", value:20000, config:"4,000 sq.m. Plot · 1,25,000 sq.ft. Leased Area · B2 + 5 Floors · Single Tenant (Highly Reputed Company) · Newly & Fully Furnished · New Lease with 3-Year Lock-in · 15% Escalation Every 3 Years · Rent ₹1.17 Cr/month", size:"1,25,000 sq.ft. leased", type:"commercial", mode:"sell", category:"Commercial", image:"https://images.pexels.com/photos/210723/pexels-photo-210723.jpeg?auto=compress&cs=tinysrgb&w=900", alt:"Fully furnished pre-rented commercial building with single reputed tenant in Sector 32, Gurugram", link:"/commercial", tag:"Available for Sale", keywords:kw("sector 32 gurgaon gurugram fully newly furnished running rented building pre-rented pre-leased single tenant big company highly reputed operator 4000 sqmt plot 125000 sqft leased area basement 2 plus 5 floors b2 5 1.17 cr per month rent 200 cr demand new lease 3 year lock-in 15 escalation every 3 years commercial investment property") },
